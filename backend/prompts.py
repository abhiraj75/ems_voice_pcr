...
3. Translate Hindi medical terms to English in your output: "saans phoolna"/"saans nahi aa rahi" -> "shortness of breath", "chakkar" -> "dizziness", "seene mein dard" -> "chest pain", "behoshi" -> "unconsciousness", "pet dard" -> "abdominal pain", "bukhaar" -> "fever", "ulti" -> "vomiting", "dast" -> "diarrhea", "dauraa" -> "seizure".
...
9. If uncertain about a critical field (vitals, meds, transport decision), note briefly in confidence_notes. Otherwise null.

EXAMPLE:

Transcript: "42 saal ka male patient, chest pain since 2 hours, ghar pe tha. BP 160 over 100, pulse 110, spo2 96. Diaphoretic skin. Aspirin 300 chewed diya. IV started normal saline. Le ja rahe hain Manipal hospital, family consent le liya. Wife saath mein hai."

Output:
{"patient_name":null,"patient_age":42,"patient_gender":"male","chief_complaint":"chest pain","history":"Chest pain for 2 hours, onset at home.","incident_location":"home","scene_type":"home","vital_hr":110,"vital_rr":null,"vital_bp":"160/100","vital_spo2":96,"vital_gcs":null,"vital_skin":"diaphoretic","treatment_airway":null,"treatment_iv":"normal saline","medications":[{"name":"aspirin","dose":"300mg","route":"oral"}],"transport_decision":"transport","destination":"Manipal Hospital","consent_obtained":true,"caregiver_present":"wife","confidence_notes":null}
